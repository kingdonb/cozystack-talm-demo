...
install:
	...
	# remote:# kubectl apply -f https://github.com/aenix-io/cozystack/raw/v0.16.4/manifests/cozystack-installer.yaml
...
template:
	...
	talm template -e 10.17.13.84 -n 10.17.13.84 -t templates/controlplane.yaml -i > nodes/dellwork03.yaml
